...
subprocess.run(["git", "commit", "-m", "feat: implement mandatory RPG Guild Passport auth (Login/Register), SQLite user persistence, and personalized quest history"], cwd=repo_dir, check=True)
